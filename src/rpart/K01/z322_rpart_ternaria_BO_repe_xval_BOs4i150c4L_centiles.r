...
PARAM$home <- "C:/Users/feder/Documents/DMEyF/dmeyf2023"

PARAM$experimento <- "HT3220s4i150c4L_competencia_centiles"
...
PARAM$semilla_azar <- c(
  105397, 260047, 449459, 562813)#, 916367)#,
...
# cargo los datos
dataset <- fread("./datasets/competencia_centiles.csv")
# entreno en 202103
